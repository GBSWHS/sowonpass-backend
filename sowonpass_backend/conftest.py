...
from sowonpass_backend.web.application import get_app
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from sowonpass_backend.db.meta import meta  # noqa: WPS433
    from sowonpass_backend.db.models import load_all_models  # noqa: WPS433
